  ...
  <PermissionGate routeName="USER_ROLE_VIEW">
    <div className="space-y-6 w-full overflow-x-hidden">
      ...
      <input 
        ...
        className="w-full sm:max-w-md bg-slate-900 border border-slate-800 rounded-lg px-4 py-2 text-white outline-none focus:border-blue-500"
        value={searchTerm}
                ...
                >
                  ...
                  <td className="p-4">
                    {user.role_id?.role_name ? (
                      <span className="inline-block bg-blue-900/40 text-blue-300 px-2 py-1 rounded border border-blue-900/50 text-xs font-bold">
                        {user.role_id.role_name}
                      </span>
                    ) : (
                      <span className="inline-block bg-slate-800 text-slate-400 px-2 py-1 rounded border border-slate-700 text-xs">
                        Simple User
                      </span>
                    )}
                  </td>
